...
class EventSite extends BasicTableModel {
   ...
   protected static function getColumns(): array { 
	...
	public function __construct(
		...
		public readonly ?float $price2X = null,
		public readonly ?float $cost2X = null,
		public readonly ?float $price3X = null,
		public readonly ?float $cost3X = null,
		public readonly ?float $price4X = null,
		public readonly ?float $cost4X = null,
	...
	public static function editEventSiteInventory(int $eventSiteID, $updateItems = [], $updateTransfers = []) {
	...
	public static function genBaseInventory(int $esID) {
			// where conditions. // see Where.php and Condition.php for explanation
	...
	public static function syncInventoryPricing(int $esID) {
		$db = Database::getDB();
